 ...
 * @author raule
 */
public class txtComponentePorfavorProfeCompileAntes extends JTextField {
    ...
    private Color lineColor = new Color(130, 129, 158);

    public txtComponentePorfavorProfeCompileAntes() {
    ...
    public void setText(String string) {
        // Asegurarse de que el valor de string no sea null antes de hacer equals
        if (string == null) {
            string = ""; // Si es null, convertirlo a una cadena vacía
        }

        // Comparar con el valor actual, también asegurándose de que no sea null
        if (!getText().equals(string)) {
            showing(string.isEmpty());
        }

        // Llamar al método setText() de la superclase
